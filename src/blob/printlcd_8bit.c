...
volatile struct _LCD_Descriptor *LCD_Descriptor_PAL, *LCD_Descriptor_HI,
    *LCD_Descriptor_LO;
...
void EnableLCD_8bit_active()
{
	...
	LCCR1 = (20 << LCD1_V_BLW) |
	    (10 << LCD1_V_ELW) |
	    (10 << LCD1_V_HSW) | ((LCD_X - 1) << LCD1_V_PPL);

	LCCR2 = (2 << LCD2_V_BFW) |
	    (2 << LCD2_V_EFW) | (2 << LCD2_V_VSW) | ((LCD_Y - 1) << LCD2_V_LPP);

	LCCR3 = (0 << LCD3_V_DPC) | (3 << LCD3_V_BPP) | (0 << LCD3_V_OEP) | (1 << LCD3_V_PCP) |	// opposite of SA1110
	    (1 << LCD3_V_HSP) |
	    (1 << LCD3_V_VSP) | (0 << LCD3_V_API) | (0xFF << LCD3_V_ACB) |
	...
	LCCR1 = (19 << LCD1_V_BLW) |
	    (9 << LCD1_V_ELW) | (9 << LCD1_V_HSW) | ((LCD_X - 1) << LCD1_V_PPL);

	LCCR2 = (1 << LCD2_V_BFW) |
	    (1 << LCD2_V_EFW) | (1 << LCD2_V_VSW) | ((LCD_Y - 1) << LCD2_V_LPP);

	LCCR3 = (0 << LCD3_V_DPC) | (3 << LCD3_V_BPP) | (0 << LCD3_V_OEP) | (0 << LCD3_V_PCP) |	// opposite of SA1110
	    (1 << LCD3_V_HSP) |
	    (1 << LCD3_V_VSP) | (0 << LCD3_V_API) | (0xFF << LCD3_V_ACB) |
	    // (5   << LCD3_V_PCD);                        // depends on mem clock!!!
	    (9 << LCD3_V_PCD);	// depends on mem clock!!!
	...
	LCCR1 = (16 << LCD1_V_BLW) |
	    (8 << LCD1_V_ELW) | (8 << LCD1_V_HSW) | ((LCD_X - 1) << LCD1_V_PPL);

	LCCR2 = (10 << LCD2_V_BFW) |
	    (10 << LCD2_V_EFW) |
	    (4 << LCD2_V_VSW) | ((LCD_Y - 1) << LCD2_V_LPP);

	LCCR3 = (0 << LCD3_V_DPC) | (3 << LCD3_V_BPP) | (0 << LCD3_V_OEP) | (1 << LCD3_V_PCP) |	// opposite of SA1110
	    (1 << LCD3_V_HSP) |
	    (0 << LCD3_V_VSP) | (0 << LCD3_V_API) | (0xFF << LCD3_V_ACB) |
	    // (5   << LCD3_V_PCD);                        // depends on mem clock!!!
	...
	LCCR0 = (0 << LCD0_V_OUM) |
	    ...
	    (1 << LCD0_V_SFM) |
	    (1 << LCD0_V_LDM) |
	    (0 << LCD0_V_SDS) | (0 << LCD0_V_CMS) | (1 << LCD0_V_ENB);
