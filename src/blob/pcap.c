...
#include <pcap.h>
	...
	SSP_PCAP_STATUS
	    SSP_PCAP_bit_set(SSP_PCAP_SECONDARY_PROCESSOR_REGISTER_BIT_TYPE
			     ssp_pcap_bit);
	SSP_PCAP_STATUS
	    SSP_PCAP_bit_clean(SSP_PCAP_SECONDARY_PROCESSOR_REGISTER_BIT_TYPE
			       ssp_pcap_bit);
	SSP_PCAP_BIT_STATUS
...
---------------------------------------------------------------------------*/
	SSP_PCAP_STATUS
		...
		case SSP_PCAP_ADJ_TX_AUD_AMPS_REGISTER:
		case SSP_PCAP_ADJ_GP_REG_REGISTER:
			ssp_pcap_gpioRead(sspPcapRegister,
					  pSspPcapRegisterValue);
			ssp_pcap_registerValue[sspPcapRegister] =
			    *pSspPcapRegisterValue &
			    SSP_PCAP_REGISTER_VALUE_MASK;
			return SSP_PCAP_SUCCESS;
			/* maybe here should NOT be a break */
			break;
		default:
