 ...
 *
 * 2004-Mar-01 - (Motorola) Expanded GPIO defs
 * 2004-May-17 - (Motorola) Added keypad and other misc defines
 * 2004-Aug-01 - (Motorola) Added SSP1 unit clock enable
 * 2005-Dec-14 - (Motorola) Added change for motorola products
 *
 */
...
#define DRCMR29		__REG(0x40000174)  /* Request to Channel Map Register for HWUART receive */
#define DRCMR30		__REG(0x40000178)  /* Request to Channel Map Register for USB endpoint 6 Request */
#define DRCMR31		__REG(0x4000017C)  /* Request to Channel Map Register for USB endpoint 7 Request */
#define DRCMR32		__REG(0x40000180)  /* Request to Channel Map Register for USB endpoint 8 Request */
#define DRCMR33		__REG(0x40000184)  /* Request to Channel Map Register for USB endpoint 9 Request */
#define DRCMR34		__REG(0x40000188)  /* Request to Channel Map Register for HWUART transmit */
...
#define DRCMRRXHWTHR	DRCMR29
#define DRCMRTXHWTHR	DRCMR34
 ...
 */
#define BULVERDE_USB_REG

#ifdef BULVERDE_USB_REG

#define UP2OCR (*((volatile unsigned long * const) 0x40600020))
#define UP2OCR_HXS (1 << 16)
#define UP2OCR_HXOE (1 << 17)
#define UP2OCR_SEOS (7 << 24)

#define UDCCR (*((volatile unsigned long * const) 0x40600000))
#define UDCCR_UDE	(1 << 0)	/* UDC enable */
#define UDCCR_UDA	(1 << 1)	/* UDC active */
#define UDCCR_UDR	(1 << 2)	/* Device resume */
#define UDCCR_EMCE	(1 << 3)	/* endpoint memory config error */
#define UDCCR_SMAC	(1 << 4)	/* switch ep memory to active config  */
//???...UDCCR not finished...

//interrupt reg
#define UDCICR0 (*((volatile unsigned long * const) 0x40600004))
#define UDCICR1 (*((volatile unsigned long * const) 0x40600008))
#define UDCISR0 (*((volatile unsigned long * const) 0x4060000c))
#define UDCISR1 (*((volatile unsigned long * const) 0x40600010))
#define UDCISR1_IRRS (1 <<27)	/* reset irq */
#define UDCISR1_IRSU (1 <<28)	/* suspend irq */
#define UDCISR1_IRRU (1 <<29)	/* resume irq */
#define UDCISR1_IRCC (1 << 31)	/* config change irq */
#define UDCISR0_IR0_PC (1 << 0)	/* ep0 irq */
#define UDCISR0_IR0_FE (1 << 1)	/* ep0 irq */
#define UDCISR0_IRA_PC (1 << 2)	/* epa irq */
#define UDCISR0_IRA_FE (1 << 3)	/* epa irq */
#define UDCISR0_IRB_PC (1 << 4)	/* epb irq */
#define UDCISR0_IRB_FE (1 << 5)	/* epb irq */
#define UDCICR0_IE0 (3 << 0)	/* ep0 interrupt enable */
#define UDCICR0_IEA (3 << 2)	/* epA interrupt enable */
#define UDCICR0_IEB (3 << 4)	/* epB interrupt enable */
#define UDCICR1_IERS (1 << 27)  /* reset interrupt enable */
#define UDCICR1_IESU (1 << 28)  /* suspend interrupt enable */
#define UDCICR1_IERU (1 << 29)  /* resume interrupt enable */
#define UDCICR1_IECC (1 << 31)  /* config change enable */

//frame number reg
#define UDCFNR (*((volatile unsigned long * const) 0x40600014))

//ep0
#define UDCCSR0 (*((volatile unsigned long * const) 0x40600100))
#define UDCCSR0_OPC	(1 << 0)	/* OUT packet completed */
#define UDCCSR0_IPR	(1 << 1)	/* IN packet ready */
#define UDCCSR0_FTF	(1 << 2)	/* Flush Tx FIFO */
#define UDCCSR0_DME	(1 << 3)	/* DMA enable for ep0 out only */
#define UDCCSR0_SST	(1 << 4)	/* Sent stall */
#define UDCCSR0_FST	(1 << 5)	/* Force stall */
#define UDCCSR0_RNE	(1 << 6)	/* Receive FIFO no empty */
#define UDCCSR0_SA	(1 << 7)	/* Setup active */
#define UDCCSR0_AREN	(1 << 8)	/* send ack */
#define UDCCSR0_ACM	(1 << 9)	/* send ack control*/

//non ep0 eps
#define UDCCSRA (*((volatile unsigned long * const) 0x40600104))
#define UDCCSRB (*((volatile unsigned long * const) 0x40600108))
//???...other ep not finished
#define UDCCSR_FS	(1 << 0)	/* FIFO need service */
#define UDCCSR_PC	(1 << 1)	/* Packet completed */
#define UDCCSR_TRN	(1 << 2)	/* Tx/Rx NAK */
#define UDCCSR_DME	(1 << 3)	/* DMA enable */
#define UDCCSR_SST	(1 << 4)	/* Sent stall */
#define UDCCSR_FST	(1 << 5)	/* Force stall */
#define UDCCSR_BNEF	(1 << 6)	/* FIFO no empty or full */
#define UDCCSR_SP	(1 << 7)	/* Short package */
#define UDCCSR_FEF	(1 << 8)	/* flush fifo */
#define UDCCSR_DPE	(1 << 9)	/* data package error*/

//data len reg
#define UDCBCR0 (*((volatile unsigned long * const) 0x40600200)) /* ep 0 data byte counter */
#define UDCBCRA (*((volatile unsigned long * const) 0x40600204)) /* ep A data byte counter */
#define UDCBCRB (*((volatile unsigned long * const) 0x40600208)) /* ep B data byte counter */
//???...other eps' len not finished...

//data reg
#define UDCDR0 (*((volatile unsigned long * const) 0x40600300)) /* ep 0 data  */
#define UDCDRA (*((volatile unsigned long * const) 0x40600304)) /* ep A data   */
#define UDCDRB (*((volatile unsigned long * const) 0x40600308)) /* ep B data   */
//???...other eps' data reg not finished...

//ep config reg
#define UDCCRA (*((volatile unsigned long * const) 0x40600404)) /* ep A config reg */
#define UDCCRB (*((volatile unsigned long * const) 0x40600408)) /* ep B config reg */
//???...other eps' data reg not finished...
//???...bit desc not defined yet...


#else //not bulverde, dalhart
...
#define UDDR4		__REG(0x40600400)  #define UDCCR_EMCE	(1 << 3)	/* endpoint memory config error *//* UDC Endpoint 4 Data Register */
...
#define GAFR2_U		__REG(0x40E00068)  /* GPIO Alternate Function Select Register GPIO<80:95> */
#define GAFR3_L		__REG(0x40E0006c)  /* GPIO Alternate Function Select Register GPIO<111:96> */
#define GAFR3_U		__REG(0x40E00070)  /* GPIO Alternate Function Select Register GPIO<112:120> */
...
#define KPC_REE1    (0x1 <<  4)  // Rotary Encodeer1 Enable */
#define KPC_REE0    (0x1 <<  3)  // Rotary Encodeer0 Enable */
